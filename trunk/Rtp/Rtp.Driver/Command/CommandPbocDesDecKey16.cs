...
{
    class CommandPbocDesDecKey16:ICommand
    {
        /// <summary>
        /// 函数
        /// 调用PBOC_DesDec_Key16(byte[] data, byte[] key16, ref byte[] dec).
        /// 结果在ctx.rbuff中。
        /// 调用方式：{PBOCDESDECKEY16(data,key16)}
        /// </summary>
        ...
        public bool execute(string commandBody, CommandContext ctx)
        {
            ...
            {
                //执行DES加密
                rc = Utility.PBOC_DesDec_Key16(data, key16, ref ctx.rbuff);
                ctx.rlen = (byte)rc;
            }
            catch (Exception ex)
            {
        ...
        {
            get { return "SYS<PBOCDESDECKEY16"; }
        }
    }
}
